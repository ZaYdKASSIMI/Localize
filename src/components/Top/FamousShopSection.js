...
export default function famousShopSection() {
  ...
  const shops = [
    { name: 'Victoria Secretes', image: 'image/shop_1.jpg' },
    { name: 'Louis Vuitton', image: 'image/shop_2.jpg' },
    { name: 'Burberry', image: 'image/shop_3.jpg' },
    { name: 'Pinko', image: 'image/shop_4.jpg' }
  ];
