                ...
                <div className="row ">
                    <div className="col-md-6 col-12 form1 ">
                      <Link to={"/page3"}>  <p className='text-start iconn'>
                        ...
                        <h2 className='hello'>what's your business categorie</h2>
                        <form className='mt-4 form2'>
                        <input type="text" className='inputB form-control' placeholder='Bussines categories' /><br/>
                       <Link to={"/page5"}> <button type="submit" class="btn btn-success mt-4 btttn">Next</button></Link>
                        </form>
                    </div>
