            ...
            <div className="container page1">
                <div className="row ">
                    ...
                    <Link to={"/page2"}><p className='text-start iconn'>
                        ...
                        <input type='text' className='inputB form-control' placeholder='Bussines number phone' /><br/>
                        <input type="email" className='inputB form-control' placeholder='name@example.com' /><br/>
                      <Link to={"/page4"}> <button type="submit" class="btn btn-success mt-4 btttn">Next</button></Link> 
                        </form>
                    </div>
